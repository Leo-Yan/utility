...
#EMAIL="k9"
#EMAILAPP="com.fsck.k9"
#EMAILACTIVITY='com.fsck.k9/.activity.Accounts'

EMAIL="email"
EMAILAPP="com.android.email"
EMAILACTIVITY="com.android.email/com.android.email.activity.Welcome"
...
(hikey)
	...
	downCount=1
	upCount=1
	UP="250 400 250 800 $flingtime"
	DOWN="250 800 250 400 $flingtime";;
(shamu|hammerhead)
	flingtime=300
	downCount=2
	upCount=6
...
if [ $startapps -gt 0 ]; then
	...
	echo Starting $EMAIL ...
	$AM_FORCE_START -n $EMAILACTIVITY
	sleep 15
fi
