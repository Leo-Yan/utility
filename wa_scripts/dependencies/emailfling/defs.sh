...
dfltAppList="duckduckgo amaze mail twidere fdroid icecat docviewer"
generateActivities=0

# default activities. Can dynamically generate with -g.
duckduckgoActivity='com.duckduckgo.mobile.android/.activity.DuckDuckGo'
amazeActivity='com.amaze.filemanager/.activities.MainActivity'
mailActivity='com.android.email/com.android.email.activity.Welcome'
conversationsActivity='eu.siacs.conversations/.ui.ConversationActivity'
twidereActivity='org.mariotaku.twidere/.activity.MainActivity'
fdroidActivity='org.fdroid.fdroid/.FDroid'
vlcActivity='org.videolan.vlc/.StartActivity'
icecatActivity='org.gnu.icecat/org.mozilla.gecko.BrowserApp'
docviewerActivity='org.sufficientlysecure.viewer/org.ebookdroid.ui.library.RecentActivity'
